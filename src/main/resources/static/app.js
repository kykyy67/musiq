            ...
            currentViewMeta() {
                const meta = {
                    home: {
                        ...
                        copy: "Простой интерфейс без технического мусора. Все списки, поиск, страницы и изменения открываются через сервер."
                    },
                    albums: {
                        kicker: "альбомы",
                        title: "Альбомы и их треки",
                        copy: "Здесь собраны альбомы с артистами, жанрами и вложенными треками."
                    },
                    tracks: {
                        kicker: "треки",
                        title: "Треки каталога",
                        copy: "Список треков с фильтрацией по названию, связью с альбомами и редактированием."
                    },
                    artists: {
                        kicker: "артисты",
                        title: "Артисты и их альбомы",
                        copy: "Раздел для работы с артистами и связями между артистами и альбомами."
                    },
                    genres: {
                        kicker: "жанры",
                        title: "Жанры и музыкальные подборки",
                        copy: "Жанры приходят с сервера постранично и показывают, где они используются."
                    },
                    users: {
                        kicker: "пользователи",
                        title: "Пользователи и любимые треки",
                        copy: "Раздел показывает связи между пользователями и треками и поддерживает полный CRUD."
                    },
                    lab: {
                        kicker: "лаборатория",
                        title: "Асинхронные задачи и concurrency",
                        copy: "Здесь можно запускать async-операции и смотреть demo race condition."
                    }
                };
